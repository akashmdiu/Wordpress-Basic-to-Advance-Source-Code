<?php
function timermaster_css_js_include(){
    
    /*=====Template CSS Files=====*/
    wp_enqueue_style('bootstrap', get_template_directory_uri().'/plugins/bootstrap/bootstrap.min.css', null, 'v1.0', all );
    wp_enqueue_style('ionicons', get_template_directory_uri().'/plugins/ionicons/ionicons.min.css', null, 'v1.1', all);
    wp_enqueue_style('ion-icons', get_template_directory_uri().'/css/fontawesome-all.min.css', null, 'v1.1', all);
    wp_enqueue_style('animation', get_template_directory_uri().'/plugins/animate-css/animate.css');
    wp_enqueue_style('slider', get_template_directory_uri().'/plugins/slider/slider.css');
    wp_enqueue_style('owl_carousel-1', get_template_directory_uri().'/plugins/owl-carousel/owl.carousel.css');
    wp_enqueue_style('owl_carousel-2', get_template_directory_uri().'/plugins/owl-carousel/owl.theme.css');
...
add_action('wp_enqueue_scripts', 'timermaster_css_js_include');
